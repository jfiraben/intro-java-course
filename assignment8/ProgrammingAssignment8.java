...
public class ProgrammingAssignment8
{
   public static void main(String[] args)
   {
      ...
      */
      ...
      PRINT_REPORT(PIE_TYPE_COUNT(pieArray2, applePie, blueberryPie, peanutbutterPie), PIE_TYPE_COUNT(pieArray2, applePie, blueberryPie, peanutbutterPie), PIE_TYPE_COUNT(pieArray2, applePie, blueberryPie, peanutbutterPie), CALCULATE_PROFIT(pieArray2, applePie, blueberryPie, peanutbutterPie, applePieProfit, blueberryPieProfit, peanutbutterPieProfit));
